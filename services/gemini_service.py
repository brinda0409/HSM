...
"""
    ...
    def synthesize_response(self, user_message, agent_results):
        ...
        """
        # If leave_agent, complaint_agent, or visitor_agent returned a multi-step agentic pipeline message, preserve it directly!
        for res in agent_results:
            if res.get("agent") in ["leave_agent", "complaint_agent", "visitor_agent"] and res.get("message") and ("Autonomous" in res.get("message") or "Pipeline" in res.get("message")):
...
"""
        ...
        for res in agent_results:
            ...
            if agent in ["complaint_agent", "leave_agent", "visitor_agent"]:
